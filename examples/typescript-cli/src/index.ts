...
// Ethers v4
const ethersRouter: EthersV4.PulseXRouter.Contract = {} as any
console.log(ethersRouter.addLiquidity('1', '2', 3, 4, 5, 6, '7', 8))
const router: Web3.PulseXRouter.Contract = {} as any
console.log(router)
...
// Web3
const fakeContract: Web3.FakeContractAbi.Contract = {} as any
console.log(fakeContract)
const fakeEvents: Web3.FakeContractAbi.Events = {} as any
