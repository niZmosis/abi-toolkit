**@ethereum-abi-types-generator/core v2.0.0** • [**Docs**](globals.md)
...
This project is licensed under the MIT License - see the [LICENSE](../../_media/LICENSE-1) file for details.
